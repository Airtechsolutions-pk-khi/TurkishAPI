...
namespace DAL.DBEntities
{
    ...
    public partial class db_a8354f_turkishpizzaEntities : DbContext
    {
        public db_a8354f_turkishpizzaEntities()
            : base("name=db_a8354f_turkishpizzaEntities")
        {
        }
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCustomerDeatil_Result>("GetCustomerDeatil");
        }
        ...
        public virtual int sp_insertLocation_Admin(string name, string description, string address, string contactNo, string email, Nullable<int> licenseID, Nullable<bool> deliveryServices, Nullable<double> deliveryCharges, string deliveryTime, Nullable<double> minOrderAmount, string longitude, string latitude, string lastUpdatedBy, Nullable<System.DateTime> lastUpdatedDate, Nullable<int> statusID, string imageURL, Nullable<int> brandID, string opentime, string closetime, string reservationOpen, string reservationClose, Nullable<int> locationID, string currency, string passcode, Nullable<double> discounts, Nullable<double> tax)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
            ...
            var reservationOpenParameter = reservationOpen != null ?
                new ObjectParameter("ReservationOpen", reservationOpen) :
                new ObjectParameter("ReservationOpen", typeof(string));
    
            var reservationCloseParameter = reservationClose != null ?
                new ObjectParameter("ReservationClose", reservationClose) :
                new ObjectParameter("ReservationClose", typeof(string));
        ...
        public virtual int spSaveCustomer(string cusromerName, string email, string mobile, string image, Nullable<int> statusID, string lastUpdatedBy, Nullable<System.DateTime> lastudateDate, Nullable<int> locationID, Nullable<int> brandId, string password)
        {
            var cusromerNameParameter = cusromerName != null ?
                new ObjectParameter("CusromerName", cusromerName) :
                new ObjectParameter("CusromerName", typeof(string));
            ...
            var lastudateDateParameter = lastudateDate.HasValue ?
                new ObjectParameter("LastudateDate", lastudateDate) :
                new ObjectParameter("LastudateDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spSaveCustomer", cusromerNameParameter, emailParameter, mobileParameter, imageParameter, statusIDParameter, lastUpdatedByParameter, lastudateDateParameter, locationIDParameter, brandIdParameter, passwordParameter);
        }
    }
}
